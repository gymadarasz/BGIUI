...
void GUITest::testButtonClick() {
	Window window;
	Button* btn1;
	(btn1 = new Button(window.getCanvas()))->setup("Push me..")->setClickHandler(GUITest::exampleButtonClicked);
	...
	int scrData[5600] = {
		...
		,7,7,7,7,7,7,7,7,7,7,7,7,7,7
		,7,7,7,7,7,7,7,7,7,7,7,7,7,7
		,7,8,8,8,8,8,8,8,8,8,7,7,7,7
		,7,7,7,7,7,7,7,7,7,7,7,7,7,7
		,7,7,7,7,7,7,7,7,7,7,7,7,7,7
		,7,7,7,7,0,0,0,7,7,7,7,7,7,7
		,7,7,7,7,7,7,7,7,7,7,7,7,7,7
		,7,7,7,7,7,0,0,7,7,7,7,7,7,7
		,7,7,7,7,7,0,7,7,7,7,7,7,7,7
		,7,7,7,7,7,7,7,7,7,7,7,7,7,7
	...
	chk(chkScr(scrData, 0, 0, 140, 40, 3), "Check screen snap area [0, 0 - 140, 40; precision:3]");
}
